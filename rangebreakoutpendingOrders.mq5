   ...
   for(int i=HistoryDealsTotal()-1;i>=0;i--)
     {
        ...
        //Print("Deal Ticket: ", dealTicket," profit: ",dealProfit);
         ...
         ulong magicno=HistoryDealGetInteger(dealTicket,DEAL_MAGIC);
         ...
         if(TimeCurrent()>=value[i].time-3*PeriodSeconds(PERIOD_M1) && TimeCurrent()<value[i].time+3*PeriodSeconds(PERIOD_M1))
           {
            ...
            msg += "Forecast : " +
            DoubleToString(value[i].forecast_value/1000000.0,2) + "\n";
            
            msg += "Previous : " +
            DoubleToString(value[i].prev_value/1000000.0,2) + "\n";
